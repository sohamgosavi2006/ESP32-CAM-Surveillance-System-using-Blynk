// Viral Science (PROGRAM CREATOR - THANKS ...) - Program Code : FOR 1 CAMERA
...
const char* ssid = "GOSWAMI";       //wifi name
const char* password = "D3418F8B23F";       //password
char auth[] = "0F0OQuxAZ2u-uH42VPplI2BUhVQV_-ro";          //Auth Code sent by Blynk
